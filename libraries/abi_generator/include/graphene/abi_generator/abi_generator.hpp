...
namespace graphene {
      ...
      FC_EXPAND_MACRO( \
       FC_MULTILINE_MACRO_BEGIN \
         ...
         {                                                                      \
           ...
           FC_THROW_EXCEPTION( graphene::chain::abi_generation_exception, #TEST ": "  __VA_ARGS__ ); \
         }                                                                      \
   ...
   struct find_yy_abi_macro_action : public PreprocessOnlyAction {
         ...
         find_yy_abi_macro_action(string& contract, vector<string>& actions, const string& abi_context
         ...
         struct callback_handler : public PPCallbacks {
            ...
            CompilerInstance& compiler_instance;
            find_yy_abi_macro_action& act;

            callback_handler(CompilerInstance& compiler_instance, find_yy_abi_macro_action& act)
